...
Hola. Este es el espacio de documentación y contexto técnico para GT Logistics, una aplicación móvil interna que desarrollamos para optimizar las entregas en Green Tomato. 
...
* **Automatización (Google Apps Script):** Tenemos un script que toma los pedidos de la semana y los cruza con nuestra base de datos de clientes. Esto limpia la información y genera órdenes únicas en nuestra tabla central de operaciones, evitando errores de digitación.
